...
public class LineChartActivity2 extends DemoBase implements OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChart.setTouchEnabled(true);//设置支持触控
        mChart.setDragDecelerationFrictionCoef(0.9f);
        mChart.setDragEnabled(true);//拖拽(平移)图表
        ...
        l.setForm(LegendForm.LINE);//修改图例
...
//        l.setYOffset(11f);
        ...
        YAxis rightAxis = mChart.getAxisRight();//右边y轴
    ...
    private void setData(int count, float range) {
        ...
        if (mChart.getData() != null &&
            ...
            set1 = new LineDataSet(yVals1, "DataSet 1");//创建一个数据集,并给它一个类型
            ...
            set2 = new LineDataSet(yVals2, "DataSet 2");//创建一个数据集,并给它一个类型
            ...
            LineData data = new LineData(set1, set2, set3);//使用数据集创建数据对象
